...
namespace FoodCorp.DataAccess.Migrations
{
    ...
    [Migration("20230417132204_AddUserPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodCorp.DataAccess.Entities.UserPermissions", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.Property<int>("PermissionsBitMask")
                        .HasColumnType("int");

                    b.HasKey("UserId");

                    b.ToTable("UserPermissions", "usr");
                });
            ...
            modelBuilder.Entity("FoodCorp.DataAccess.Entities.UserPermissions", b =>
                {
                    b.HasOne("FoodCorp.DataAccess.Entities.User", "User")
                        .WithOne("Permissions")
                        .HasForeignKey("FoodCorp.DataAccess.Entities.UserPermissions", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
